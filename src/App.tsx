...
export const App = () => {
	...
	return (
		<div className='w-screen h-screen flex flex-col items-center justify-center text-gray-100 p-2 md:p-0'>
			...
			<form className='flex flex-col gap-4 items-stretch w-full md:max-w-[400px] max-w-[100%] md:mt-10 mt-5'>
